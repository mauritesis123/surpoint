...
## ??? BUSCA MAX DIFERENCIA PARA  CUANDO CONVIENE COMPRAR 
...
class Market:
    ...
    def __init__(self, sampler, last_n_timesteps, buy_cost, risk_averse=0.):
        ...
        self.action_labels = ["don't (buy  & sell)", "buy", "hold"]            ## CASH, BUY, HOLD
        self.sampler = sampler                                                 ## sampler
        self.last_n_timesteps = last_n_timesteps                               ## tamaño ventana de referencia= 40 
        self.buy_cost = buy_cost                                               ## constante c=3.3
        self.risk_averse = risk_averse                                         ## 
        self.state_shape = (last_n_timesteps, 1)                               ##
        self.start_index = last_n_timesteps - 1                                ##
        self.current_index = self.start_index                                  ## indice del precio en la serie.  va actualizandoce 
    ...
    ##  RESETEAR PRECIOS DESPUES DE TRANSCURRIDO UN EPISODIO
    ...
    ## RECOMPENSA PARA ACCIONES NO CASH
    ...
    ### FUNCION QUE ENTREGA RECOMPENSAS DADA LA ACCION
    def step(self, action):
     ...
     # retorna estado, recompensa , indice, acciones validas
